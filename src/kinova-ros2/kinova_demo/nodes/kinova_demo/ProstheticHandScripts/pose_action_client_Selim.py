...
if __name__ == '__main__':
    ...
    # Lift/Init Pose
    positionWP_Init = [0.57, 0.15, 0.3, -0.0, 89.1, -160.4]

    # Pick Pose
    positionWP_Pick = [0.57, 0.0, 0.1, -0.0, 89.1, -160.4]

    # Place Pose
    positionWP_Place = [0.57, 0.3, 0.1, -0.0, 89.1, -160.4]

    # Turn off relative movement of the tip in cartesian mode.
    relativeFlag = False

    for i in range(5):
    	# Readable but bad code design
