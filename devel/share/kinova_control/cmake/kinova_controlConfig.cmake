...
if("TRUE" STREQUAL "TRUE")
  set(kinova_control_SOURCE_PREFIX /home/srl-jacoarm/Desktop/SRL-JacoArm/src/kinova-ros/kinova_control)
  set(kinova_control_DEVEL_PREFIX /home/srl-jacoarm/Desktop/SRL-JacoArm/devel)
  ...
  set(kinova_control_INSTALL_PREFIX /home/srl-jacoarm/Desktop/SRL-JacoArm/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kinova_control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Siddharth Oli <soli@kinova.ca>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kinova_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/srl-jacoarm/Desktop/SRL-JacoArm/src/kinova-ros/kinova_control/${idir}'.  Ask the maintainer 'Siddharth Oli <soli@kinova.ca>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${kinova_control_dep}_FOUND)
      find_package(${kinova_control_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${kinova_control_dep} REQUIRED ${depend_list})
  endif()
