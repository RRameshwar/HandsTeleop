...
if("TRUE" STREQUAL "TRUE")
  set(kinova_driver_SOURCE_PREFIX /home/srl-jacoarm/Desktop/SRL-JacoArm/src/kinova-ros/kinova_driver)
  set(kinova_driver_DEVEL_PREFIX /home/srl-jacoarm/Desktop/SRL-JacoArm/devel)
  ...
  set(kinova_driver_INSTALL_PREFIX /home/srl-jacoarm/Desktop/SRL-JacoArm/install)
...
if(NOT "/home/srl-jacoarm/Desktop/SRL-JacoArm/devel/include;/home/srl-jacoarm/Desktop/SRL-JacoArm/src/kinova-ros/kinova_driver/include " STREQUAL " ")
  set(kinova_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/srl-jacoarm/Desktop/SRL-JacoArm/devel/include;/home/srl-jacoarm/Desktop/SRL-JacoArm/src/kinova-ros/kinova_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kinova_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Kinova ROS Support <ros@kinovarobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kinova_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/srl-jacoarm/Desktop/SRL-JacoArm/src/kinova-ros/kinova_driver/${idir}'.  Ask the maintainer 'Kinova ROS Support <ros@kinovarobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${kinova_driver_dep}_FOUND)
      find_package(${kinova_driver_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${kinova_driver_dep} REQUIRED ${depend_list})
  endif()
